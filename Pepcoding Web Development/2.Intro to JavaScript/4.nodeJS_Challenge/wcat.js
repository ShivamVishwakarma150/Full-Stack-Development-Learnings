...
// Isme " - " se start hone wale optionsArr me jayega
let optionsArr = [];
// Nhi to Files Array Me Jayega
let filesArr = [];
// identify -> options
...
// options check (agar -b and -n dono ek sath koi use lar liya to)
...
// -s 
let isSPreset = optionsArr.includes("-s"); // It gives true or false.
if (isSPreset == true) {
